...
import com.miPortfolio.FGorgulho.Dto.dtoExperiencia;
import com.miPortfolio.FGorgulho.Entity.Experiencia;
import com.miPortfolio.FGorgulho.Security.Controller.Mensaje;
import com.miPortfolio.FGorgulho.Service.ImpExperienciaService;
...
public class ExperienciaController {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
        ...
        experiencia.setDondeE((dtoexp.getDondeE()));
